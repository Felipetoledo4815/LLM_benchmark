...
def check_prompt_consistency(prompt: str, images: List[str], rel_questions: List[str]) -> None:
    ...
    assert prompt_starts_with_user, "Prompt should start with user placeholder. \
        We have not implemented system role definition."
    ...
    assert count_user_start == count_user_end, "Number of user placeholders should be equal to the number of \
        user end placeholders."
    ...
    assert count_rel_question_placeholders == len(rel_questions), "Number of relationship questions \
...
def check_prompt_consistency_few_shots(prompt: str) -> None:
    ...
    assert count_system_start == count_system_end, "Number of system placeholders should be equal to the number of \
        system end placeholders."
    ...
    assert count_user_placeholders > count_system_placeholders, "Number of user placeholders should be greater \
        than system placeholders. No need to add system placeholder at the end."
